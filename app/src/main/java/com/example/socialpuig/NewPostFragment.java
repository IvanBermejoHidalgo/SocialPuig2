...
public class NewPostFragment extends Fragment {
    ...
    private void guardarEnFirestore(String postContent, String mediaUrl) {
        ...
        Post post = new Post(user.getUid(), user.getUid(),user.getDisplayName(), (user.getPhotoUrl() != null ? user.getPhotoUrl().toString() : "R.drawable.user"), postContent, System.currentTimeMillis(),mediaUrl, mediaTipo);
